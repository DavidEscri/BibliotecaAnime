...
| **Cubre** | los **50 ficheros `.py`** de `src/`: **31 módulos reales** (**11 430** líneas) + 19 `__init__.py`, ✅ **todos vacíos** |
...
| [10-invariantes-y-trampas.md](10-invariantes-y-trampas.md) | **Lee esto siempre.** **39** trampas con síntoma observable |
