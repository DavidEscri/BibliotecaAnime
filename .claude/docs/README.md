...
| **Cubre** | los **50 ficheros `.py`** de `src/`: **31 módulos reales** (**11 599** líneas) + 19 `__init__.py`, ✅ **todos vacíos** |
...
| [10-invariantes-y-trampas.md](10-invariantes-y-trampas.md) | **Lee esto siempre.** **40** trampas con síntoma observable |
...
| **Cualquier cosa de la interfaz** | [06](06-gui-y-vistas.md) → trampas **29-37, 39 y 40** (todas de CustomTkinter y de layout) → [11 §1 y §1b](11-playbooks.md) |
