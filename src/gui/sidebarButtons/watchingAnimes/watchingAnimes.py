...
class WatchingAnimeButton(utilsButtons.SidebarButton):
    ...
    def __show_browser(self):
        ...
        search_entry = ctk.CTkEntry(
            search_frame,
            placeholder_text="Buscar entre los animes que estoy viendo...",
        ...
        self.__display_animes(self.animes_persistence.get_watching_animes())
    ...
    def __search_anime(self, search_entry: ctk.CTkEntry):
        ...
        for anime in query_animes:
            ...
            if not res or len(finished_anime) == 0:
                continue
            if not finished_anime[0]["is_watching"]:
                continue
            print(f"{finished_anime[0]['title']} encontrado entre los animes que estoy viendo")
    ...
    def __display_animes(self, pending_animes: List[AnimeRecord]):
        ...
        for index, anime_record in enumerate(pending_animes):
            ...
            image = load_image(get_resource_path(f"resources/images/watching/{anime_record.anime_id}.jpg"))
